...
var isAbsoluteURL = __webpack_require__(861);
var combineURLs = __webpack_require__(862);
...
var debug = __webpack_require__(866);
...
exports.humanize = __webpack_require__(869);
...
var utils = __webpack_require__(9);
var normalizeHeaderName = __webpack_require__(858);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(859);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __webpack_require__(865);
  }
  return adapter;
}
...
const axios = __webpack_require__(852);

exports.main = (context, sendResponse) => {
  const functionResponse = "Congratulations! This is Hello world";
  const portalId = process.env['HUBSPOT_PORTAL_ID'];
  const queryParams = context.params; // Access the query parameters
...
// what_information_do_you_want_from_the_portal
// what_information_do_you_want_from_the_portal
// what_information_do_you_want_from_the_portal
// what_information_do_you_want_from_the_portal_other
// what_is_your_area_of_interest_relating_to_medical_cannabis
// what_is_your_area_of_interest_relating_to_medical_cannabis
// what_is_your_area_of_interest_relating_to_medical_cannabis
...
axios.CancelToken = __webpack_require__(873);
...
axios.spread = __webpack_require__(874);

// Expose isAxiosError
axios.isAxiosError = __webpack_require__(875);
...
var InterceptorManager = __webpack_require__(855);
var dispatchRequest = __webpack_require__(856);
var mergeConfig = __webpack_require__(126);
var validator = __webpack_require__(872);
...
var utils = __webpack_require__(9);
var transformData = __webpack_require__(857);
...
var parseHeaders = __webpack_require__(863);
var isURLSameOrigin = __webpack_require__(864);
var createError = __webpack_require__(93);
var defaults = __webpack_require__(47);
var Cancel = __webpack_require__(48);
...
var http = __webpack_require__(25);
var https = __webpack_require__(33);
var httpFollow = __webpack_require__(123).http;
var httpsFollow = __webpack_require__(123).https;
var url = __webpack_require__(13);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(867)("follow-redirects");
    }
    catch (error) { /* */ }
...
var tty = __webpack_require__(871);
