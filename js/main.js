(function() {
  ...
  $(document).on('click','#hs-eu-confirmation-button',function(){
   ...
   $(document).on('click','#hs-eu-decline-button',function(){
    alert("declined clicked");
  });
  
   $(document).on('click','#hs-eu-cookie-settings-button',function(){
    console.log("cookie settings clicked");
  });
  
  $(document).on('click','#hs-modal-accept-all',function(){
