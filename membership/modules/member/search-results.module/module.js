...
//     var searchParams = new URLSearchParams(window.location.search.slice(1));
    var searchParams = new URLSearchParams(editedSearchParams(window.location.search.slice(1)));
    
    // Custom Function
    function editedSearchParams(queryString){
      console.log(queryString);
      var params = queryString.split('&');
      var filteredParams = params.filter(function(param) {
          return !param.startsWith('tableId=');
      });
